...
export KUBE_FEATURE_GATES='EndpointSlice=true,ServiceTopology=true'
...
KUBE_GCE_ZONE=us-central1-a "${KUBE_ROOT}/cluster/kube-up.sh"
KUBE_USE_EXISTING_MASTER=true KUBE_GCE_ZONE=us-central1-b "${KUBE_ROOT}/cluster/kube-up.sh"
